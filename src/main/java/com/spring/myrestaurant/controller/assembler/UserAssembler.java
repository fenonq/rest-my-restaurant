...
public class UserAssembler extends RepresentationModelAssemblerSupport<UserDto, UserModel> {
    ...
    public static final String USER_CART = "get_user_cart";
    ...
    public UserModel toModel(UserDto entity) {
        ...
        Link get = linkTo(methodOn(UserController.class).getUser(entity.getUsername())).withSelfRel();
        ...
        Link userCart = linkTo(methodOn(UserController.class).getUserCart(null))
                .withRel(USER_CART);
        ...
        userModel.add(getAll, get, update, ban, change, userCart, addDish, removeDish);
